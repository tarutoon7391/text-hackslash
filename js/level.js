...
const SKILL_TREE_DEFINITIONS = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'sg_08', name: '属性魔法', type: 'skill', skillId: 'sage_blast', description: '攻撃しながら自己回復（ATK×1.0 / 最大HPの15%回復 / MP:60）', mpCost: 60, bonuses: {}, cost: 2, requires: 'sg_07' },
      ...
      { id: 'sg_12', name: '高等吸魔', type: 'passive', description: 'パッシブ：最大MPを1.3倍にする', bonuses: {}, cost: 3, requires: 'sg_11' },
      { id: 'sg_13', name: '賢者の技', type: 'stat', description: 'ATK +8 / MP +15', bonuses: { atk: 8, mp: 15 }, cost: 3, requires: 'sg_12' },
      { id: 'sg_14', name: '聖魔融合', type: 'skill', skillId: 'holy_magic_fusion', description: '攻撃と回復を同時に行う（ATK×2.5 / 最大HPの10%回復 / MP:80）', mpCost: 80, bonuses: {}, cost: 3, requires: 'sg_13' },
      ...
      { id: 'sg_18', name: '知恵の波動', type: 'skill', skillId: 'wisdom_wave', description: '攻撃と大回復（ATK×3.5 / 最大HPの20%回復 / MP:110）', mpCost: 110, bonuses: {}, cost: 2, requires: 'sg_17' },
      { id: 'sg_19', name: '全体強化', type: 'skill', skillId: 'sage_mega_buff', description: '強力な自己バフ（ATK×1.5 / DEF×1.4 / 4ターン / MP:80）', mpCost: 80, bonuses: {}, cost: 2, requires: 'sg_18' },
...
function useSkill(skillId) {
  ...
  switch (skillId) {
    ...
    case 'sage_buff': {
      // 強化魔法: ATK×1.2 / DEF×1.2 5ターン（倍率バフ・乗算スタック）
      game.sageBuff = { atkMultiplier: 1.2, defMultiplier: 1.2, turnsLeft: 5 };
      log(`📖✨ ${player.name} は「強化魔法」を唱えた！ 5ターン ATK×1.2 / DEF×1.2`, 'player-action');
      break;
    }

    case 'holy_magic_fusion': {
      // 聖魔融合: ATK×2.5 攻撃 + 最大HPの10%自己回復
    ...
    case 'sage_mega_buff': {
      // 全体強化: ATK×1.5 / DEF×1.4 4ターン（倍率バフ・乗算スタック）
      game.sageMegaBuff = { atkMultiplier: 1.5, defMultiplier: 1.4, turnsLeft: 4 };
