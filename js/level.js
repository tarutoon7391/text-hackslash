...
/* ==============================================================
   ...
   236pt ≒ 235pt 目標を達成し、5ルート（188pt + 魔剣士47pt = 235pt）完走が可能。
   ============================================================== */
 ...
 *   Lv1〜99 総計: 236pt（5ルート合計235ptに対して1pt余裕）
 * レベルアップ時のステータス成長:
 *   Lv2〜50:  ATK+1 / DEF+1 / HP+5 / MP+3
 *   Lv51〜99: ATK+1 / DEF+1 / HP+3 / MP+2（HP/MPのみ緩やか）
...
function gainExp(expGained) {
  ...
  while (player.level < MAX_LEVEL && player.exp >= EXP_TABLE[player.level]) {
    ...
    // レベルアップによる自然成長（Lv51以降は HP/MP 成長を緩やかに）
    player.attackBase  += 1;
