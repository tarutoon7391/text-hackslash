...
const SKILL_TREE_DEFINITIONS = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'sg_12', name: '高等吸魔', type: 'passive', description: 'パッシブ：最大MPが1.3倍になる', bonuses: {}, cost: 3, requires: 'sg_11' },
...
function useSkill(skillId) {
  ...
  switch (skillId) {
    ...
    case 'sage_buff': {
      ...
      game.sageBuff = { atkMult: 1.2, defMult: 1.2, turnsLeft: 5 };
    ...
    case 'sage_mega_buff': {
      ...
      game.sageMegaBuff = { atkMult: 1.5, defMult: 1.4, turnsLeft: 4 };
