...
function showScreen(screenName) {
  const screens = ['login', 'lobby', 'dungeon-type', 'dungeon-select', 'special-dungeon-select', 'battle', 'inventory', 'skill-tree', 'encyclopedia', 'ranking', 'gacha', 'gacha-dungeon-difficulty'];
